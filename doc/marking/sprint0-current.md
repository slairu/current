...
**Team Name:** current  
**Github:** https://github.com/CSCC012023/final-project-s23-current
...
## product.md (Max 36 marks)
  ...
  - Market research has been done (max 2 marks)
    ...
    Your mark = 1 (are there any existing companies that already offer this?)
  ...
  - The idea has business potential (max 2 marks)
    ...
    Your mark = 1 (not extremely inconvenient for users to rely on multiple platforms)
...
- Competition has been identified clearly (max 2 marks) 
    ...
    Your mark: 1 (mentioned they rely on a combination of Microsoft/Google/Zoom services but for example Microsoft itself would be a competition as it has outlook calendar/microsoft teams etc. all compatible with each other)
...
- Team organization (roles) divided clearly (max 2 marks)
    ...
    Your mark: 1 (who is focusing on frontend, backend, or fullstack?)
...
- Prioritizing user stories (max 2 marks)
    ...
    Your mark: 1 (is there any way on how you decide one user story is higher priority than another? ex. planning poker)
...
## Documentation: README.md (max 3 marks)
  ...
  - Installation for your Software/System
    ...
    Your mark: 0.5 (for .env.development, good to put template of what env variable are needed)
  ...
  - Contribution
    ...
    Your mark: 0 (What is the flow someone would follow to contribute?)
