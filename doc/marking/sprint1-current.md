...
## Daily Stand-ups (max 10 marks)
  ...
  Daily Stand-ups Total Mark: 7.5 / 10 (some members missing in couple standups, some standup reports also "late" (ie. should be reported as a group at same time))
...
## Tracking on JIRA  (max 20 marks) 
  ...
  - Tasks Distribution (max 3 marks)
    ...
    Your Mark: 2.5 (assigned but not completed)
...
Tracking on JIRA Total Mark: 13.5 / 20
...
## Sprint Completion (Max 20 marks) 
  ...
  Sprint Completion Total Mark: 18 / 20 (CUR-1, CUR-2, CUR-15, CUR-16 completed)
...
## Sprint Demo (Max 14 marks) 
  ...
  - Working software (max 8 marks)
    ...
    Your Mark: 7 (bug with auth0 adding to db during demo)
  ...
  - Documentation (max 2 marks)
    ...
    Your Mark: 1.5 (add more comments (eg. brief description for frontend components, etc))

Sprint Demo Total Mark: 12 / 14
